...
is_deeply [ $construct_with_list->get_data ], $data,  "correct data for construct_with_list";

my $construct_with_ref = new_ok 'Spreadsheet::HTML', [ { data => $data } ];
is_deeply [ $construct_with_ref->get_data ], $data,  "correct data for construct_with_ref";
