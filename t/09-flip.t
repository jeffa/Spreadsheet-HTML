...
is $table->flip, $expected,                         "correct HTML from method call" ;
is Spreadsheet::HTML::flip( $data ), $expected,     "correct HTML from procedural call (array ref arg)" ;
is Spreadsheet::HTML::flip( @$data ), $expected,    "correct HTML from procedural call (list arg)" ;


is Spreadsheet::HTML::flip( data => $data, matrix => 1 ), 
...
is Spreadsheet::HTML::flip( data => $data, headless => 1 ), 
