...
is Spreadsheet::HTML::east( data => $data, matrix => 1 ), 
   ...
   "east correct HTML from procedural call (list arg)";
...
is $table->east( flip => 1 ), $expected,                        "east: correct HTML from method call" ;
is Spreadsheet::HTML::east( $data, flip => 1 ), $expected,      "east: correct HTML from procedural call (array ref arg)" ;
is Spreadsheet::HTML::east( @$data, flip => 1 ), $expected,     "east: correct HTML from procedural call (list arg)" ;
...
is $table->south( flip => 1 ), $expected,                       "south: correct HTML from method call" ;
is Spreadsheet::HTML::south( $data, flip => 1 ), $expected,     "south: correct HTML from procedural call (array ref arg)" ;
is Spreadsheet::HTML::south( @$data, flip => 1 ), $expected,    "south: correct HTML from procedural call (list arg)" ;
...
is Spreadsheet::HTML::south( data => $data, flip => 1, matrix => 1 ), 
   ...
   "south: correct HTML from procedural call (list arg)" 
;
...
$table = Spreadsheet::HTML->new( data => $data );
is $table->north( flip => 1 ), $expected,                           "north( flip => 1 ): correct HTML from method call" ;
is Spreadsheet::HTML::north( $data, flip => 1 ), $expected,         "north( flip => 1 ): correct HTML from procedural call (array ref arg)" ;
is Spreadsheet::HTML::north( @$data, flip => 1 ), $expected,        "north( flip => 1 ): correct HTML from procedural call (list arg)" ;
...
is Spreadsheet::HTML::north( data => $data, flip => 1, matrix => 1 ), 
   ...
   "north( flip => 1 ): correct HTML from procedural call (list arg)" 
;
