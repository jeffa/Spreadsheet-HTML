...
is scrub( $generator->conway( fill => '2x2' ) ),
    $html,
    "2x2 fill conway as method correct";

is scrub( Spreadsheet::HTML::conway( fill => '2x2' ) ),
    $html,
...
is scrub( $generator->conway( fill => '2x2', empty => undef, matrix => 1 ) ),
    $html,
    "2x2 fill conway with empty and matrix as method correct";

is scrub( Spreadsheet::HTML::conway( fill => '2x2', empty => undef, matrix => 1 ) ),
    $html,
...
is scrub( $generator->conway( data => [1..4], wrap => 2 ) ),
    $html,
    "2x2 wrapped data conway as method correct";

is scrub( Spreadsheet::HTML::conway( data => [1..4], wrap => 2 ) ),
    $html,
