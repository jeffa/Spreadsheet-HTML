...
is_deeply $no_data->process_data, [ ['&nbsp;'] ],                                       "correct data from method for no args";
...
is_deeply $one_string->process_data, [ [1] ],                                           "correct data from method for one scalar string";
...
is_deeply $oned_one_element->process_data, [ [1] ],                                     "correct data from method for 1d array ref with 1 element";
...
is_deeply $twod_empty->process_data, [ ['&nbsp;'] ],                                    "correct data from method for empty 2d array ref";
...
is_deeply $one_element->process_data, [ [1] ],                                          "correct data from method for 2d array ref with one element";
